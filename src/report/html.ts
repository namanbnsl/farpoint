...
.analytics{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin-top:18px}
.panel{border:1px solid var(--line);border-radius:10px;padding:17px;background:var(--paper)}
...
.costs{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}
.cost{padding:12px;background:var(--surface);border-radius:6px}
...
.routing{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}
.route{padding:12px;background:var(--surface);border-radius:6px}
...
.analytics{gap:20px;margin-top:28px}
.panel{padding:24px;border:0;border-radius:10px;background:var(--surface)}
.panel-head{margin-bottom:20px}
.costs,.routing{gap:12px}
.cost,.route{padding:16px;background:var(--paper)}
.bar-list{gap:14px}
